...
# [Version 6.0.3 Download link (the "no Google" version for use with Netlify web hosting --- best for GDPR)](https://github.com/shawnbanasick/eq-web-sort/releases/download/v6.0.3/eq-web-sort-603-NO-Google.zip)

## Netlify's GDPR [compliance statement](https://docs.netlify.com/platform/security-checklist/)

# [Version 6.0.3 Download link (the Google version for use with Firebase or Google Sheets)](https://github.com/shawnbanasick/eq-web-sort/releases/download/v6.0.3/eq-web-sort-603-WITH-Google.zip)
